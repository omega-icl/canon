...
/*!
\page page_GAMS_CRONOS GAMS File Reader for CRONOS
...
#ifndef MC__GAMS_CRONOS_HPP
#define MC__GAMS_CRONOS_HPP
...
#define MC__GAMS_CRONOS_DEBUG
#define MC__GAMS_CRONOS_TRACE

namespace mc
{

//! @brief C++ class for importing a GAMS model into CRONOS
////////////////////////////////////////////////////////////////////////
//! mc::GAMS_CRONOS is a C++ class for importing a GAMS model into
//! CRONOS. It relies on the GAMS model object (GMO) generated by GAMS,
...
( bool const disp )
{
  ...
  if( gmoGetEquTypeCnt( _gmo, gmoequ_N ) )
   ...
   // CRONOS cannot handle problems without decision variables
   if( !gmoN( _gmo ) ){
     gevLogStat( _gev, "Error: CRONOS requires variables.\n" );
     gmoSolveStatSet( _gmo, gmoSolveStat_Capability );
     gmoModelStatSet( _gmo, gmoModelStat_NoSolutionReturned );
     return false;
   }

  // CRONOS cannot handle semicontinuous, semiinteger or SOS
  if( gmoGetVarTypeCnt( _gmo, gmovar_SC ) > 0
   || gmoGetVarTypeCnt( _gmo, gmovar_SI ) > 0 ){
    gevLogStat( _gev, "ERROR: Semicontinuous and semiinteger variables not supported in CRONOS.\n" );
    gmoSolveStatSet( _gmo, gmoSolveStat_Capability );
    gmoModelStatSet( _gmo, gmoModelStat_NoSolutionReturned );
    return false;
  }
  ...
  if( gmoGetVarTypeCnt( _gmo, gmovar_S1 ) > 0
   || gmoGetVarTypeCnt( _gmo, gmovar_S2 ) > 0 ){
    gevLogStat( _gev, "ERROR: Special ordered sets not supported in CRONOS.\n");
    gmoSolveStatSet( _gmo, gmoSolveStat_Capability );
    gmoModelStatSet( _gmo, gmoModelStat_NoSolutionReturned );
    return false;
  }
