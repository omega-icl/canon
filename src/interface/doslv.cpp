...
void mc_doslv( py::module_ &m )
{
typedef mc::FFGraph< mc::FFODE<0>, mc::FFGRADODE<0> > FFGraph;
#ifdef MC__USE_SNOPT
  typedef mc::NLPSLV_SNOPT<mc::FFODE<0>, mc::FFGRADODE<0>> NLPSLV;
#elif  MC__USE_IPOPT
  typedef mc::NLPSLV_IPOPT<mc::FFODE<0>, mc::FFGRADODE<0>> NLPSLV;
#endif

py::class_<NLPSLV> pyDOSLV( m, "DOSLV" );
...
py::enum_<NLPSLV::STATUS>(pyDOSLV, "DOSLV.STATUS", py::module_local())
...
py::enum_<NLPSLV::t_OBJ>(pyDOSLV, "DOSLV.OBJ", py::module_local())
 .value("MIN", NLPSLV::t_OBJ::MIN, "minimization" )
 .value("MAX", NLPSLV::t_OBJ::MAX, "maximization" )
 .export_values()
;

py::enum_<NLPSLV::t_CTR>(pyDOSLV, "DOSLV.CTR", py::module_local())
...
py::class_<mc::SOLUTION_OPT> pyDOSLVSol( pyDOSLV, "DOSLV.Solution", py::module_local() );
...
py::class_<NLPSLV::Options> pyDOSLVOptions( pyDOSLV, "DOSLV.Options" );
...
py::enum_<NLPSLV::Options::QP_STRATEGY>(pyDOSLVOptions, "DOSLV.QP_STRATEGY")
...
py::enum_<NLPSLV::Options::HESSIAN_STRATEGY>(pyDOSLVOptions, "DOSLV.HESSIAN_STRATEGY")
...
py::enum_<NLPSLV::Options::LINEAR_SOLVER>(pyDOSLVOptions, "DOSLV.LINEAR_SOLVER")
...
py::enum_<NLPSLV::Options::GRADIENT_STRATEGY>(pyDOSLVOptions, "DOSLV.GRADIENT_STRATEGY")
