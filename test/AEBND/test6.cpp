...
int main()
{
  ...
  BND.options.BOUNDER  = mc::AEBND<DAG,I,PM,PV>::Options::ALGORITHM::GS;//KRAW;//GE;
  BND.options.PRECOND  = mc::AEBND<DAG,I,PM,PV>::Options::PRECONDITIONING::INVMD;//INVMD;//NONE;

  BND.options.BLKDEC = mc::AEBND<DAG,I,PM,PV>::Options::DECOMPOSITION::NONE;
  BND.setup();
  std::cout << "\nSuccessful? " << (BND.solve( Ip, Ix1, Ix0 )==mc::AEBND<DAG,I,PM,PV>::NORMAL?"Y\n":"N\n");

  BND.options.BLKDEC = mc::AEBND<DAG,I,PM,PV>::Options::DECOMPOSITION::DIAG;
  BND.setup();
  std::cout << "\nSuccessful? " << (BND.solve( Ip, Ix2, Ix0 )==mc::AEBND<DAG,I,PM,PV>::NORMAL?"Y\n":"N\n");

  BND.options.BLKDEC = mc::AEBND<DAG,I,PM,PV>::Options::DECOMPOSITION::RECUR;
  BND.setup();
  std::cout << "\nSuccessful? " << (BND.solve( Ip, Ix3, Ix0 )==mc::AEBND<DAG,I,PM,PV>::NORMAL?"Y\n":"N\n");
...
/*
  ...
  std::cout << "\nSuccessful? " << (BND.solve( SOL )==mc::AEBND<DAG,I,PM,PV>::NORMAL?"Y\n":"N\n");
