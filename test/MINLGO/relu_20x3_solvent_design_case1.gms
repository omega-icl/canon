...
$GDXIN relu_20x3_solvent_design_case1.gdx
...
eq_sur7(lay1)..
nn_sum_l1(lay1) =e= sum(nf,w_l1(nf,lay1)*inps(nf)) + b_l1(lay1);

eq_sur8(lay1)..
nn_act_l1(lay1) =e= relu(nn_sum_l1(lay1));

eq_sur9(lay2)..
nn_sum_l2(lay2) =e= sum(lay1,w_l2(lay1,lay2)*nn_act_l1(lay1)) + b_l2(lay2);

eq_sur10(lay2)..
nn_act_l2(lay2) =e= relu(nn_sum_l2(lay2));

eq_sur11(lay3)..
nn_sum_l3(lay3) =e= sum(lay2,w_l3(lay2,lay3)*nn_act_l2(lay2)) + b_l3(lay3);

eq_sur12(lay3)..
nn_act_l3(lay3) =e= relu(nn_sum_l3(lay3));

eq_sur13(lay4)..
nn_sum_l4(lay4) =e= sum(lay3,w_l4(lay3,lay4)*nn_act_l3(lay3)) + b_l4(lay4);

eq_sur14(lay4)..
nn_act_l4(lay4) =e= 1/(1+exp(-nn_sum_l4(lay4)));

eq_sur15(lay4)..
nn_act_l4(lay4) =g= 0.5;
