...
////////////////////////////////////////////////////////////////////////
{
  ...
  std::vector<mc::FFVar> FCT( NY*NS*NS, 0 );  // State functions
  for( unsigned i=0; i<NS; i++ ){
    FCT[NY*NS*i+NY*i]   = y1;
    FCT[NY*NS*i+NY*i+1] = y2;
  }
/*
  mc::FFVar FCT[NY*NS];  // State functions
  for( unsigned i=0; i<NS; i++ ){
    FCT[NY*i]   = y1;
    FCT[NY*i+1] = y2;
  }
*/
  ...
  IVP.set_function( NS, NS*NY, FCT.data() );
  //IVP.set_function( NS, NY, FCT );
  IVP.setup();
/*
  /////////////////////////////////////////////////////////////////////////
  // Simulate IVP-ODE
...
*/
  ...
  // Output variance
  //double YVAR[NY] = { 4e-2, 4e-2 };
  double YVAR[NY*NS] = { 4e-2, 4e-2, 4e-2, 4e-2, 4e-2, 4e-2, 4e-2, 4e-2, 4e-2, 4e-2 };
  ...
  DOE.set_parameters( NP, P, l_PSAM );
  DOE.setup();
